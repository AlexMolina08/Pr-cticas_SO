...
//crea archivo1 si no existe con permisos rw--wxrw-
// abre con permisos de escritura
...
umask(0); // establecemos umask = 000

// crea archivo 2 si no existe con permisos rw--wxrw-
...
//CAMBIO DE PERMISOS
// llamada a stat para obtener estructura stat en atributos
...
// en atributos.st_mode están los permisos del archivo (campo de bits)
// los permisos son 666 , ya que no hay mask 



// elimina permisos de x a g y activa el bit especial
// S_ISGID (grupo que ejecuta es como owner)
